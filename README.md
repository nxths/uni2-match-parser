...
# Limitations
This windowed branch only works on the particular video layout for the [@yamino999](https://www.youtube.com/@yamino999/streams) youtube channel. Use the main/fullscreen branch for fullscreen gameplay footage.
